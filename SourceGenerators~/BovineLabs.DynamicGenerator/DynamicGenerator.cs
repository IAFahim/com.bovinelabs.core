    ...
    public class DynamicGenerator: IIncrementalGenerator
    {
            ...
            GeneratorSyntaxContext ctx, CancellationToken cancellationToken)
        {
            ...
            foreach (var interfaceSymbol in ts.AllInterfaces)
            {
                ...
                switch (name)
                {
                    ...
                    case "IDynamicIndexedMap" when typeParamCount == 3:
                        return new DynamicData(ts, DynamicType.IndexedMap, interfaceSymbol.TypeArguments[0], interfaceSymbol.TypeArguments[1], interfaceSymbol.TypeArguments[2]);
        ...
        private static void InitializeMethod(ClassBuilder builder, DynamicData data)
        {
            ...
            initialize.WithBody(b =>
            {
                var init = data.Type switch
                {
                    ...
                    DynamicType.IndexedMap => $"InitializeIndexedMap<{data.TypeName}, {data.Type1}, {data.Type2}, {data.Type3}>",
        ...
        private static void AsMapMethod(ClassBuilder builder, DynamicData data)
        {
            var rt = data.Type switch
            {
                ...
                DynamicType.IndexedMap => $"DynamicIndexedMap<{data.Type1}, {data.Type2}, {data.Type3}>",
            ...
            asMap.WithBody(b =>
            {
                var a = data.Type switch
                {
                    ...
                    DynamicType.IndexedMap => $"AsIndexedMap<{data.TypeName}, {data.Type1}, {data.Type2}, {data.Type3}>",
